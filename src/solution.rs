...
mod tests {
    ...
    fn is_valid() {
        ...
        assert_eq!(s.get_is_valid(), true);

        s.set_bit(2, true);
        assert_eq!(s.get_bit(0), false);
        assert_eq!(s.get_bit(1), false);
        assert_eq!(s.get_bit(2), true);
        assert_eq!(s.get_bit(3), false);
        assert_eq!(s.get_bit(4), false);

        s.set_bit(2, false);
        assert_eq!(s.get_bit(2), false);
    }
